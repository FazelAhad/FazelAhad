...
- **Fast-Pizza** – A React-based pizza delivery app with a modern UI using **Tailwind CSS**.
- **Odoo Pharmacy System** – A custom ERP module for managing pharmacy stock, sales, and reporting in **Odoo**.
- **Next.js Blog** – A simple, SEO-friendly blog built using **Next.js** and **Markdown**.
